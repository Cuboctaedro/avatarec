...
<section class="py-8 container bg-no-repeat circles-container" >
    <h2 class="font-bold text-xl sm:text-2xl md:text-3xl text-teal-600 text-center">Unser Angebot:</h2>
    <div class="flex flex-col lg:flex-row flex-wrap items-center justify-center relative circles" >
        ...
        foreach ($angebot->children() as $child) {
            $image = $child->section_image()->exists() ? $child->section_image()->toFile()->thumb([
                'width'   => 300,
                'height'  => 300,
                'quality' => 80,
                'crop' => true
